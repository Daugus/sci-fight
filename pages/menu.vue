...
<template>
  <div class="flex scale-150 flex-col justify-center gap-6 text-center align-middle">
    ...
    <div class="flex justify-around">
      ...
      <div class="mt-9 flex w-16 flex-col justify-center gap-2 align-middle">
        <!-- Daño -->
        <img src="/src/img/assets/stats_damage.png" />
        <!-- Vida -->
        <img src="/src/img/assets/stats_health.png" />
        <!-- Velocidad -->
        <img src="/src/img/assets/stats_speed.png" />
      </div>

      <!-- Jugador 2 -->
      <MenuFicha :rotar="true"></MenuFicha>
    </div>
